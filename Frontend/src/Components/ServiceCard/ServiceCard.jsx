...
const ServiceCard = ({ data }) => {
    ...
    return (
        <div className='SCradContainer rounded-xl border-4 border-[#fca311] bg-white  max-w-[360px] mt-[15px] me-[15px] mb-[15px] hover:scale-[1.05] transition-all ease-in-out duration-300 '>
